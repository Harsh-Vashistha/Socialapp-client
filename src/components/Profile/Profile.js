...
class Profile extends Component {
    ...
    render() {
        ...
        const {userData,loading,authenticated}={...this.props.user}
        const{credentials}={...userData}
        const {handle,imageUrl,website,createdAt,bio,location}={...credentials}
        
        
        
        
        // user:{handle,imageUrl,website,createdAt,bio,location,loading,authenticated}}= this.props;
       // const usercopy = JSON.parse(JSON.stringify(userData))
      //  const {credentials:{}}=usercopy
